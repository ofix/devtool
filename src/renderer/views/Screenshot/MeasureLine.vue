<template>
  ...
  const initWebGL = async () => {
    ...
    // 3. 获取着色器变量位置
    glCache.value.locations.a_position = gl.getAttribLocation(program, "a_position");
  ...
  const renderLineWithWebGL = (direction) => {
    ...
    gl.vertexAttribPointer(glCache.value.locations.a_position, 2, gl.FLOAT, false, 0, 0);
