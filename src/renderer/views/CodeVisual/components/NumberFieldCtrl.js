...
import FieldType from "./FiledType.js";

class NumberFieldCtrl extends FieldCtrl {
    constructor({ key, label, value = '', height = 30 }) {
        super({ key, label, type: FieldType.NUMBER, value, height });
        this.typeWidth = 0;
...
export default NumberFieldCtrl;