        ...
        <div class="grid-1x4">
            ...
            >
                ...
                <div class="share-header" v-if="share">
                    ...
                    <span
                        class="price"
                        :class="share.changeRatio >= 0 ? 'up' : 'down'"
                    >
                        {{ share.price || "--" }}
                    </span>
                    <span
                    ...
                    <div class="chart-type-toggle">
                        ...
                        <el-dropdown
                            @command="
                                (type) => handleKlineTypeChange(type, share)
                            "
                            effect="dark"
                            type="small"
                        >
                            ...
                            <template #dropdown>
                                <el-dropdown-menu class="kline-dropdown-menu">
                                    <el-dropdown-item command="minute"
                                        >分时</el-dropdown-item
                                    >
...
async function refreshRealTimeData() {
    for (const share of displayList.value) {
        ...
        if (type === "minute") {
            ...
            if (data) {
                share.price = data[0].price;
                share.changeRatio = data[0].changeRatio;
            }
            const randomTime = Math.floor(Math.random() * 6000) + 6000;
