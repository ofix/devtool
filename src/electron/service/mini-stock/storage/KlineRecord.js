...
export class KlineRecord {
    ...
    // 输出 CSV 格式
    toCSV() {
        return `${this.date},${this.timestamp},${this.open},${this.high},${this.low},${this.close},${this.preClose ?? ''},${this.change ?? ''},${this.changeRatio ?? ''},${this.volume},${this.amount},${this.turnoverRatio}`;
    }
}